...
void sleep_gpio_GPA1_config(void)
{
	 ...
	 *  GPIO sleep configuration:
	 *
	 *  GPA1[3] = "10" Input, GPA1[2] = "10" Input, GPA1[1] = "10" Input,    GPA1[0] = "10" Input;
	 *  
...
void sleep_gpio_GPB_config(void)
{
	...
	sleep_config |= (1 << 15 | 1 << 14 | 1 << 13 | 1 << 12 | 1 << 11 | 1 << 10 | 1 << 9 | 1 << 8 | 1 << 2 | 1 << 0);
	sleep_config &= ~( 1 << 7 | 1 << 6 | 1<< 5 | 1 << 4 | 1 << 3 | 1<< 1 );		
...
void sleep_gpio_GPC0_config(void)
{
	...
	sleep_config |= (1 << 8 | 1 << 7 | 1 << 5 | 1 << 6 | 1<< 1 );
...
void sleep_gpio_GPJ0_config(void)
{
	 ...
	 *  GPIO sleep configuration:
	 *
	 *  GPJ0[7] = "10" Input,    GPJ0[6] = "01" Output 1, GPJ0[5] = "10" Input,    GPJ0[4] = "10" Input;
	 *  GPJ0[3] = "00" Output 0, GPJ0[2] = "10" Input,    GPJ0[1] = "10" Input,    GPJ0[0] = "10" Input;
	 *  
	 *  Register Bit [15 ~ 0] = 1001 1010 0010 1010
	 */
	sleep_config = readl(S5PV210_GPJ0CONPDN);
	sleep_config |= (1 << 15 | 1 << 12 | 1 << 11 | 1 << 9 | 1<< 5 | 1 << 3 | 1<< 1);
	sleep_config &= ~( 1 << 14 |  1 << 13 | 1 << 10 | 1 << 8 | 1 << 7 | 1 << 6 | 1 << 4 | 1 << 2 | 1 << 0 );		
...
void sleep_gpio_GPJ1_config(void)
{
	 ...
	 *  GPJ1[3] = "10" Input, 	GPJ1[2] = "01" Output 1,    GPJ1[1] = "10" Input,    GPJ1[0] = "10" Input;
	 *  
	 *  Register Bit [11 ~ 0] = 0100 1001 1010
	 */
	sleep_config = readl(S5PV210_GPJ1CONPDN);
	sleep_config |= (  1 << 10 | 1 << 7 | 1<< 4 | 1 << 3 | 1<< 1);
	sleep_config &= ~(  1 << 11 | 1 << 9 | 1 << 8 | 1 << 6 | 1 << 5 | 1 << 2 | 1 << 0 );		
...
void sleep_gpio_GPJ2_config(void)
{
	 ...
	 *  GPJ2[3] = "00" Output 0, GPJ2[2] = "00" Output 0, GPJ2[1] = "10" Input,    GPJ2[0] = "00" Output 0;
	 *  
	 *  Register Bit [15 ~ 0] = 1111 1100 0000 1000
	 */
	sleep_config = readl(S5PV210_GPJ2CONPDN);
	sleep_config |= (1 << 15 | 1 << 14 | 1 << 13 | 1 << 12 | 1 << 11 | 1 << 10 | 1 << 3);
	sleep_config &= ~( 1 << 9 | 1 << 8 | 1 << 7 | 1 << 6 | 1<< 5 | 1 << 4 | 1 << 2 | 1<< 1 | 1 << 0 );		
...
void sleep_gpio_GPJ3_config(void)
{
	 ...
	 *  GPIO sleep configuration:
	 *
	 *  GPJ3[7] = "10" Input   , GPJ3[6] = "00" Output 0, GPJ3[5] = "10" Input,    GPJ3[4] = "10" Input;
	 *  GPJ3[3] = "00" Output 0, GPJ3[2] = "10" Input,    GPJ3[1] = "10" Input,    GPJ3[0] = "00" Output 0;
	 *  
	 *  Register Bit [15 ~ 0] = 1000 1010 0010 1000
	 */
	sleep_config = readl(S5PV210_GPJ3CONPDN);
	sleep_config |= (1 << 15 | 1 << 11 | 1 << 9 | 1 << 5 | 1 << 3);
	sleep_config &= ~( 1 << 14 | 1 << 13 | 1 << 12 | 1 << 10 | 1 << 8 | 1 << 7 | 1 << 6 | 1 << 4 | 1 << 2 | 1 << 1 | 1 << 0 );		
...
void sleep_gpio_GPJ4_config(void)
{
	 ...
	 *
	 *  GPJ4[4] = "00" Output 0;
	 *  GPJ4[3] = "10" Input,   GPJ4[2] = "00" Output 0,   GPJ4[1] = "10" Input,    GPJ4[0] = "10" Input;
	 *  
	 *  Register Bit [9 ~ 0] = 01 1000 1010
	 */
	sleep_config = readl(S5PV210_GPJ4CONPDN);
	sleep_config |= ( 1 << 7 | 1 << 3 | 1 << 1 );
