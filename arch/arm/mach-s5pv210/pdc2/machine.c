...
#include "dev-wm8994.h"

//cherry add touch
#if defined CONFIG_VENUS_TOUCHSCREEN_UC6511
#include <linux/venus/uc6511.h>
#endif

#if defined CONFIG_VENUS_TOUCHSCREEN_RAYDIUM
...
//#ifdef CONFIG_MF206_3G
//#include <linux/venus/mf206_3g.h>
//#endif

#include <linux/mutex.h>
static DEFINE_MUTEX(power_mutex);
unsigned long wifi_bt_set_power(unsigned long power);
...
//S5PV210_LCD_HEIGHT set to 640 to suit the framebuff size must 4K-aligned
#define S5PV210_LCD_WIDTH   800
#define S5PV210_LCD_HEIGHT  640
...
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_JPEG (21496 * SZ_1K)
...
#ifdef CONFIG_RESERVE_MEMSIZE_SHARE_REGION
    [10] = {
        .id = 0xFF,
        .name = "share_region",
        .bank = 1,
        .memsize = CONFIG_RESERVE_MEMSIZE_SHARE_REGION * SZ_1K,
        .paddr = CONFIG_RESERVE_OFFSET_SHARE_REGION,
    },
#endif
};

static struct regulator_consumer_supply ldo3_consumer[] = {
    //[0] = REGULATOR_SUPPLY("pd_io", "s3c-usbgadget"),
...
static struct regulator_consumer_supply ldo8_consumer[] = {
    //[0] = REGULATOR_SUPPLY("pd_core", "s3c-usbgadget"),
...
//1GHz voltage
    ...
    .dvsarm3    = 0xc,
    .dvsarm4    = 0xc,
#elif defined(CONFIG_PRODUCT_PDC3) || defined(CONFIG_PRODUCT_PDC3_DVT2) || defined(CONFIG_PRODUCT_PDC3_FOG) || defined(CONFIG_PRODUCT_KS8)
    .dvsarm1    = 0xc,  /* 1.35v */
    .dvsarm2    = 0xc,
    .dvsarm3    = 0xc,
    .dvsarm4    = 0xc,
...
#ifdef CONFIG_VENUS_KEYBOARD_GPIO
extern struct platform_device gpiokeys_device;
#endif

#ifdef CONFIG_I2C_GPIO
extern struct platform_device gpioi2c3_device;
extern struct platform_device gpioi2c4_device;
extern struct platform_device gpioi2c5_device;
extern struct platform_device gpioi2c6_device;
//extern struct platform_device gpioi2c7_device;
#endif
...
static struct s3c_platform_fb at070tna2_fb_data __initdata = {
        .hw_ver = 0x62,
        .nr_wins = 5,
        .default_win = CONFIG_FB_S3C_DEFAULT_WINDOW,
        .swap = FB_SWAP_WORD | FB_SWAP_HWORD,
...
#ifdef CONFIG_FB_S3C_A080SN03
static struct s3c_platform_fb a080sn03_fb_data __initdata = {
        .hw_ver = 0x62,
        .nr_wins = 5,
        .default_win = CONFIG_FB_S3C_DEFAULT_WINDOW,
        .swap = FB_SWAP_WORD | FB_SWAP_HWORD,
...
#ifdef CONFIG_FB_S3C_A080SN01
static struct s3c_platform_fb a080sn01_fb_data __initdata = {
        .hw_ver = 0x62,
        .nr_wins = 5,
        .default_win = CONFIG_FB_S3C_DEFAULT_WINDOW,
        .swap = FB_SWAP_WORD | FB_SWAP_HWORD,
...
static struct platform_pwm_backlight_data smdk_backlight_data = {
    ...
    .dft_brightness = 255,
#if defined(CONFIG_VENUS)
    .pwm_period_ns  = 15515,    // jimmy modify for lcd pwm, pwm clk set 64.5K
#else
    .pwm_period_ns  = 78770,
#endif
};
...
static struct platform_device smdk_backlight_device = {
    ...
    .dev        = {
#if defined(CONFIG_VENUS)
        .parent = &s3c_device_timer[1].dev,     // jimmy modify for lcd pwm
#else   
...
#ifdef CONFIG_VENUS_TOUCHSCREEN_UC6511
static struct uc6511_platform_data uc6511_config = {
    .model          = 6511,
    .x_max          = 4095,
    .y_max          = 4095,
    .pressure_min   	= 0,
...
//cherry add
#ifdef CONFIG_VENUS_TOUCHSCREEN_UC6511
    {
        ...
        .platform_data = &uc6511_config,
    },
#endif

#ifdef CONFIG_VENUS_TOUCHSCREEN_RAYDIUM
{
...
extern struct charge_platform_data smb137b_platdata;        // jimmy add 20110120
/* I2C3 */
...
#endif
    {
        I2C_BOARD_INFO("max17044", 0x36),
        .irq = IRQ_EINT8,
    },

    //{ I2C_BOARD_INFO("cm3217",    0x10/*CM3217_SLAVE_ADDR_1*/), },
    {
        I2C_BOARD_INFO("smb137b",     0x16),
        .platform_data = &smb137b_platdata,
        .irq = IRQ_EINT5,
...
#define USB_DETECT_GPIO     S5PV210_GPH0(6)	
#define POWER_KEY_GPIO      S5PV210_GPH0(1)
static void smdkc110_power_off(void)
{
  /*  int usb_level, p_key_level;
   // mdelay(400);  //mdelay(2000);
    p_key_level =  __gpio_get_value(POWER_KEY_GPIO);
    usb_level = __gpio_get_value(USB_DETECT_GPIO);
  //  mdelay(40);  //mdelay(50);
    p_key_level |=  __gpio_get_value(POWER_KEY_GPIO);
    usb_level &= __gpio_get_value(USB_DETECT_GPIO);
    if (p_key_level == 0 || usb_level == 1 )     // before PS_HOLD out high --> low, check power key and USB ;
    {
...
#ifdef CONFIG_VENUS_POWER_BATTERY
...
static struct bcm4329_bt_data bcm4329_bt_data = {
        .gpio_pwr       = S5PV210_GPH3(0),
        .gpio_reset     = S5PV210_GPJ3(5),
};

static struct platform_device bcm4329_bt_device = {
        .name   = "bcm4329-bt",
        .id     = -1,
        .dev.platform_data = &bcm4329_bt_data,
};
...
static struct platform_device bcm4751_gps_device = {
        .name   = "bcm4751-gps",
        .id     = -1,
};
#endif

#ifdef CONFIG_BCM4329_WIFI
...
extern struct platform_device power_control_device; // jimmy add for power control interface
...
//  &gpioi2c7_device,
    ...
    &s3c_device_timer[3],
#endif
    &power_control_device,          // add by jimmy
#ifdef CONFIG_SWITCH_GPIO
...
static void __init smdkc110_machine_init(void)
{
    ...
    i2c_register_board_info(0, i2c_devs0, ARRAY_SIZE(i2c_devs0));
		/*   
    if (get_hw_version_before_init() == EVT2_BOARD)
    {	
        i2c_register_board_info(3, i2c_devs1, ARRAY_SIZE(i2c_devs1));
        i2c_register_board_info(1, i2c_devs3, ARRAY_SIZE(i2c_devs3));
    }
    else if (get_hw_version_before_init() == EVT3_BOARD)
    {
        i2c_register_board_info(1, i2c_devs1, ARRAY_SIZE(i2c_devs1));
        i2c_register_board_info(3, i2c_devs3, ARRAY_SIZE(i2c_devs3));
    }
    */
    board_version_n = get_hw_version_before_init();
    printk("board version is %d\n", board_version_n);
...
#ifdef CONFIG_FB_S3C_AT070TNA2
        s3cfb_set_platdata(&at070tna2_fb_data);
#endif

#ifdef CONFIG_FB_S3C_A080SN03
        s3cfb_set_platdata(&a080sn03_fb_data);
#endif
#ifdef CONFIG_FB_S3C_A080SN01
		s3cfb_set_platdata(&a080sn01_fb_data);
#endif
...
u32 tmp;
  ...
  //  printk("~~~~~power_count_require=%d+++++++++\n",power_count);
exit:
    mutex_unlock(&power_mutex);
    return;
}
EXPORT_SYMBOL(require_module);
...
EXPORT_SYMBOL(release_module);
 
unsigned long wifi_bt_set_power(unsigned long power)
{
    if (power)
    {
        gpio_request(S5PV210_GPH3(0), "GPH3");
        gpio_direction_output(S5PV210_GPH3(0), 1);
        gpio_free(S5PV210_GPH3(0));
       // printk(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>BCM4329_WIFI_BT: power  ON\n"); 
#if 1
	mdelay(100);
              gpio_request(S5PV210_GPJ2(1), "GPJ2");
              s3c_gpio_setpull(S5PV210_GPJ2(1), S3C_GPIO_PULL_NONE);
              gpio_direction_output(S5PV210_GPJ2(1), 1);
              gpio_free(S5PV210_GPJ2(1));  
#endif 	  
                gpio_request(S5PV210_GPJ3(5), "GPJ2");
              s3c_gpio_setpull(S5PV210_GPJ3(5), S3C_GPIO_PULL_NONE);
    ...
    else
    {
              ...
              gpio_request(S5PV210_GPJ3(5), "GPJ2");
              s3c_gpio_setpull(S5PV210_GPJ3(5), S3C_GPIO_PULL_NONE);
              gpio_direction_output(S5PV210_GPJ3(5), 0);
              gpio_free(S5PV210_GPJ3(5));
	...
	mdelay(100);
        ...
        gpio_free(S5PV210_GPH3(0));	
      //  printk(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>BCM4329_WIFI_BT: power  OFF\n");	     
    }
    return 0;
}
EXPORT_SYMBOL(wifi_bt_set_power);
