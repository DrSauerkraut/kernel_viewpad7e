...
/*20111221 Evan add HDMI debounce, start*/
#define HDMI_DEBOUNCE 
/*20111221 Evan add HDMI debounce, end*/
...
static void hdmi_timer_handler(void)
{	
...
/*20111221 Evan add HDMI debounce, start*/
#ifdef HDMI_DEBOUNCE
	mod_timer(&hdmi_timer, jiffies + msecs_to_jiffies(1000));
#else
	schedule_work(&g_hpd_work);
#endif
/*20111221 Evan add HDMI debounce, end*/
...
/*20111221 Evan add HDMI debounce, start*/
	...
	hdmi_timer.function = &hdmi_timer_handler;
