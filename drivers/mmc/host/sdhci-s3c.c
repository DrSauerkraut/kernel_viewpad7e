...
//static struct wake_lock sd_lock;
extern void SendPowerbuttonEvent( void );


#if 1	// for SD DYNAMIC insert or remove
...
static struct   work_struct	sd_monitor_work;

static const char sd_driver_name[] = "s3c-driver-sdhci";

#define  SD_DET_WAKE			S5PV210_GPH2(3)
#define  SD_DYNAMIC      1

static spinlock_t s3c_sd_changed_lock;
static int is_sd_wakeup=0;
extern int early_suspend_stat;
int sd_early_suspend;
#endif
...
{
//	wake_lock_init(&sd_lock, 0, "sd_lock");
